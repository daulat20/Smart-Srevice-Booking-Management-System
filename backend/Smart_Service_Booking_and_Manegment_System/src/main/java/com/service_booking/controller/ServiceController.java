...
import com.service_booking.service.ServiceService;
...
public class ServiceController {
    ...
    public Services addService(@RequestBody Services service,
        ...
        return serviceService.addService(service, provider);
    }

    @GetMapping("/search")
    public List<Services> search(@RequestParam String keyword) {
